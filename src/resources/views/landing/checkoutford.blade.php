...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets/landing/assets/img/vehicle.png') }}" class="img-fluid" alt=""> 
            </div>
    ...
    <p class="fst-italic" style="text-align: justify">
        Es uno de los coches más esperados para los entusiastas de los muscle cars americanos y uno que promete traer sensaciones fuertes a todos aquellos que se atrevan a exprimir al máximo su motor. Hablamos del Ford Mustang Shelby GT500 2020.
        Porque el nuevo Shelby GT500, tendrá una potencia oficial de 771 CV y 847 Nm de par máximo, procedentes de un bloque V8 de aleación de aluminio de 5.2 litros sobrealimentado, el mismo que GT350 pero que aquí se lleva más allá. Estamos por tanto ante el Mustang más potente homologado para carretera que ha salido de fábrica.
        El asterisco de este impresionante coche lo supimos hace unos meses cuando se confirmó que a pesar de ello este Shelby no pasaría de los 300 km/h (289 km/h), teniendo así una punta menor que la de su predecesor. Pero todo esto tiene una razón, y es que, como veremos, en este Shelby GT500 se ha trabajado muy a fondo en el apartado aerodinámico.
